    ...
    def __init__(
        ...
        *,
        ...
        description = (
            ...
            "\n**Important**: Paths with Chinese characters are automatically normalized for compatibility."
        )
    ...
    def _run_shell_command(
        ...
        *,
        ...
        try:
            ...
            # Ensure workspace root is properly encoded for subprocess
            # This fixes issues with Chinese characters in paths on Windows
            workspace_root = os.path.normpath(self._workspace_root)
